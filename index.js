...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
     ...
     if (!isNsfw) return reply('⚡disponivel apenas no pv⚡')
				...
				case 'tisu':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/nz83rm1.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Tisu del Zapϟ\nDono/fundador da fcc ᬊ͜͡𝑹𝑨ϟ𝑶⚡\nCanal: https://youtube.com/channel/UC7JdGFqRraNbKLCv5UTWtVA\nInscrevam-se 😗'})
					break
				case 'bot':
			     	memein = await kagApi.memeindo()
