	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\n Lindo❤, seja bem vindo ao grupo ${mdata.subject}\n Leia as regras e use a tag para nao ser removido ❤⚡ /tag `
	...
	client.on('chat-update', async (mek) => {
     ...
     if (!isNsfw) return reply('⚡disponivel apenas no pv⚡')
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝐂𝐑𝐈𝐀𝐃𝐎𝐑: 𝐷𝑂𝐵𝐵𝑌♱᭄\n𝐂𝐎𝐍𝐓𝐀𝐓𝐎: wa.me/+5511911219615\n𝐈𝐍𝐒𝐓𝐀: to sem aff kk\n\n\nDìgite ${prefix}bot para ver comandos basicos para criar um bot'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
