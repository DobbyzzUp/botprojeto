...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				only: {
					...
					admin: '❗𝐂𝐨𝐦𝐚𝐧𝐝𝐨 𝐞𝐱𝐜𝐥𝐮𝐬𝐢𝐯𝐨 𝐩𝐚𝐫𝐚 𝐚𝐝𝐦𝐢𝐧𝐬, 𝐚𝐥𝐚 𝐨 𝐦𝐞𝐦𝐛𝐫𝐨 𝐜𝐨𝐦𝐮𝐦 𝐪𝐮𝐞𝐫𝐞𝐧𝐝𝐨 𝐮𝐬𝐚𝐫 𝐜𝐨𝐦𝐚𝐧𝐝𝐨𝐬 𝐝𝐞 𝐚𝐝𝐞𝐦𝐢𝐫𝐨𝐬 𝐊𝐊𝐊❗',
 	 ...
 	 case 'oculto':
					...
					if (mute || pvmte) return console.log('Ignorando comando', id)
            ...
            break
              ...
              reply(hasil)
				...
				case 'chamada':
					...
					teks += '🔥!𝐀𝐓𝐄𝐍𝐂𝐀𝐎 𝐌𝐄𝐌𝐁𝐑𝐎𝐒!🔥\n\n'
					for (let mem of groupMembers) {
						teks += `⚡@${mem.jid.split('@')[0]}👈Gay\n`
